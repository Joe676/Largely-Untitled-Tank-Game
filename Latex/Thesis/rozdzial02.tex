...
\begin{table}
    \small
    \centering
    \caption{Rozk³ad liczby rund dla ró¿nej liczby graczy i docelowych punktów zwyciêstwa.\\ $(n - docelowa\ liczba\ punktów\ zwyciêstwa)$}
...
Buforowanie akcji odnosi siê do techniki, w której polecenia wydawane przez gracza s¹ zapisywane w przypadku gdy nie jest mo¿liwe wykonanie ich natychmiast. Akcje wywo³ywane przez te polecenia zostaj¹ aktywowane w momencie gdy nastanie taka mo¿liwoœæ. 
