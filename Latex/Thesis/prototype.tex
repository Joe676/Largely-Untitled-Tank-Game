...
Zosta³ wprowadzony schemat sterowania zgodny z ustaleniami sekcji \ref{sec:steering_concept} oraz tabeli \ref{tab:steering}. 
...
Podstawowy system sieciowy zosta³ zaimplementowany z wykorzystaniem wideoporadnika \cite{godot_network_tutorial}. Ostateczna implementacja zosta³a jednak dostosowana do przygotowywanego rozwi¹zania, poniewa¿ projekt z poradnika jest tworzony z wykorzystaniem grafiki 2D.
...
Ponadto w skrypcie \texttt{Network} zdefiniowane s¹ funkcje \texttt{create\_server}\ref{create_server_prototype} i \texttt{join\_server}\ref{join_server_prototype} s³u¿¹ce do, odpowiednio, stworzenia serwera i do³¹czenia do serwera. W tym celu wykorzystana zosta³a klasa \texttt{NetworkedMultiplayerENet}, implementuj¹ca warstwê sieciow¹ korzystaj¹c¹ z po³¹czenia UDP.
